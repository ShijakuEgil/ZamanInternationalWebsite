...
?>
 <div class="row no-gutters container-fluid calendar-main-container">
   ...
   <div class="col-3 calendar-past-event-wrapper">
       ...
       <h1 class="past-events-title text-center"><?php the_field( 'past_events_title', get_id_by_slug( 'calendar' ) );?></h1>
       <?php
           $args = array(
               'posts_per_page' => -1,
               'post_type' => 'event',
...
?>
   ...
   <div class="col-3 calendar-upcomming-container text-center">
       ...
       <h1 class="text-center"><?php the_field( 'calendar_of_events_title', get_id_by_slug( 'calendar' ) ); ?></h1>
       ...
       <div class="calendar-month-view row container-fluid no-gutters">
           ...
           <div class="calendar-month-wrapper jan col-4" data-month="Jan"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($jan != 0): ?>
                   <p class="lead text-center"> <?php echo $jan ?>  <?php if($jan > 1): echo 'events'; else: echo 'event'; endif; ?></p>
              <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper feb col-4" data-month="Feb"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($feb != 0): ?>
                   <p class="lead text-center"> <?php echo $feb ?> <?php if($feb > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper mar col-4" data-month="Mar"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($mar != 0): ?>
                   <p class="lead text-center"> <?php echo $mar ?> <?php if($mar > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper apr col-4" data-month="Apr"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               <p class="lead calendar-month">APRIL</p>
                    <?php if($apr != 0): ?>
               <p class="lead text-center"> <?php echo $apr ?> <?php if($apr > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper may col-4" data-month="May"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($may != 0): ?>
                   <p class="lead text-center"> <?php echo $may ?> <?php if($may > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper jun col-4" data-month="Jun"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($jun != 0): ?>
                   <p class="lead text-center"> <?php echo $jun ?> <?php if($jun > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper jul col-4" data-month="Jul"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($jul != 0): ?>
                   <p class="lead text-center"> <?php echo $jul ?> <?php if($jul > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper aug col-4" data-month="Aug"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($aug != 0): ?>
                   <p class="lead text-center"> <?php echo $aug ?> <?php if($aug > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper sep col-4" data-month="Sep"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($sep != 0): ?>
                   <p class="lead text-center"> <?php echo $sep ?> <?php if($sep > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper oct col-4" data-month="Oct"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($oct!= 0): ?>
                   <p class="lead text-center"> <?php echo $oct ?> <?php if($oct > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper nov col-4" data-month="Nov"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($nov != 0): ?>
                   <p class="lead text-center"> <?php echo $nov ?> <?php if($nov > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
           ...
           <div class="calendar-month-wrapper dec col-4" data-month="Dec"  data-url="<?php echo admin_url('admin-ajax.php'); ?>">
               ...
               <?php if($dec != 0): ?>
                   <p class="lead text-center"> <?php echo $dec ?> <?php if($dec > 1): echo 'events'; else: echo 'event'; endif; ?></p>
               <?php endif; ?>
           </div>
       ...
       <button
            type="button"
            class="calendar-reset-btn btn btn-light my-5 w-75"
            name="button"
            data-url="<?php echo admin_url('admin-ajax.php'); ?>">
            Reset
        </button>
       <h1 class="text-center mt-5"><?php the_field( 'get_involved_area_title', get_id_by_slug( 'calendar' ) ); ?></h1>
       <div class="calendar-btn-group btn-group-vertical w-75" role="group" aria-label="Basic example">
         <button onclick="window.location='<?php the_field('top_button_page_link', get_id_by_slug( 'calendar' ) ); ?>';" type="button" class="btn btn-lg btn-light"><?php the_field( 'top_button_text', get_id_by_slug( 'calendar') ); ?></button>
         <button onclick="window.location='<?php the_field('middle_button_page_link', get_id_by_slug( 'calendar' ) ); ?>';" type="button" class="btn btn-lg btn-light"><?php the_field( 'middle_button_text', get_id_by_slug( 'calendar') ); ?></button>
         <button onclick="window.location='<?php the_field('bottom_button_page_link', get_id_by_slug( 'calendar' ) ); ?>';" type="button" class="btn btn-lg btn-light"><?php the_field( 'bottom_button_text', get_id_by_slug( 'calendar') ); ?></button>
       </div>
   </div>
 </div>
<?php get_footer(); ?>

<?php
/*
 * Template Name: Project UI
 * Template Post Type: hope-4-humanity
 *
 */
 get_header();  ?>
         ...
         <?php while ( have_posts() ): the_post();?>
            ...
            <article id="post-<?php the_ID();?>" <?php post_class("single-post-div default-display"); ?>>
                ...
                <div class="single-post-image" style="background-image: url('<?php echo zaman_get_featured_image(); ?>')">
                  ...
                  <?php elseif(get_post_type() == 'hope-for-humanity-post'): ?>
                        <h1 class="single-page-brand">Hope For humanity</h1>
                  <?php endif; ?>
